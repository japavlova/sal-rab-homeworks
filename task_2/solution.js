function calcShipping(sum, min, shipping) {
    ...
    console.log(productsSum, "сумма в корзине");
    console.log(freeShippingMinSum, "минимальная цена для бесплатной доставки");
    console.log(shippingPrice, "стоимость доставки");
...
function calcDiscount(sum, min, discount) {
    ...
    console.log(productsSum, "сумма в корзине");
    console.log(discountMinSum, "минимальная цена для скидки");
    console.log(discountPart, "величина скидки в процентах");
